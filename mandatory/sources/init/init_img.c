...
/*   Updated: 2024/08/10 09:29:10 by afont            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_init_img4(t_data *data)
{
	...
	ft_protect_img(data, data->all_img.east_wall.img_ptr);
	...
	ft_protect_img(data, data->all_img.south_wall.img_ptr);
...
void	ft_init_img3(t_data *data)
{
	...
	ft_protect_img(data, data->all_img.west_wall.img_ptr);
	...
	ft_protect_img(data, data->all_img.north_wall.img_ptr);
	...
	four.height);
	ft_protect_img(data, data->all_img.four.img_ptr);
	ft_init_img4(data);
}
...
void	ft_init_img2(t_data *data)
{
	...
	seven.height);
	ft_protect_img(data, data->all_img.seven.img_ptr);
...
void	ft_init_img(t_data *data)
{
	...
	three.height);
	ft_protect_img(data, data->all_img.three.img_ptr);
	ft_init_img2(data);
}
